...
The list is hosted in a public [github repository](https://github.com/jmir17/scrumChecklist) because receiving new contributions is very welcome.
...
- [ ] Scrum team is cross-functional, to have all competencies needed to accomplish the work.
	...
	##### Development Team
	- [ ] Work incrementaly and iteratively.
	...
	- [ ] Helps to change the interactions with and within the scrum team to maximize the value created.
		...
		- [ ] Understand and to practice agility.
		...
		- [ ] Coach in other organization environtments where scrum is not fully adopted or understood. 
